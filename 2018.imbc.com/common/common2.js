...
var navData = {
    "title": ['영상', 'VR', '뉴스', '일정/결과', '메달순위', '대회소개'],
    "url": ['vod', '', 'news', 'schedule', '', 'about']
}

var snsLink ={
    facebook :'https://www.facebook.com/PyeongChang2018',
    twitter:'https://twitter.com/PyeongChang2018',
    insta:'https://www.Instagram.com/PyeongChang2018'
}
...
$(document).ready(function () {
    ...
    var navHtml = '';
        ...
        for (var i = 0; i < navData.title.length; i++) {
            if(navData.url[i] !== ''){
                ...
                navHtml += '<li class="nav-'+ navData.url[i] +'"><a href="#popup">' + navData.title[i] + '</a></li>';
            }
        }
        navHtml += '</ul>';
    ...
    var footerHtml ='';
     ...
     var popupHtml ='';
         popupHtml ='<div class="popup-ban" id="popup"> 메달 순위 집계시 제공 예정입니다.'
    ...
    $(".nav-").click(function(e){
        e.preventDefault();
        $(".popup-ban").show();
        $(".popup-ban").children(".btn").on('click',function(){
            $(this).parent(".popup-ban").hide();
        });
    });
});
...
function itemsList(){
    ...
    innerHtml = '<div class="game-area">'
                        ...
                        +    '<li class="tab11"><a href="'+gate+'#items11"><span class="icon gam11"></span><p class="name">소트트랙<br>스피드 스케이팅</p></a></li>'
